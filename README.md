...
Я Backend разработчик с коммерческим опытом web разработки с использованием языков программирования
Python и JavaScript. Я разрабатываю легко масштабируемые и надёжные решения на реальных проектах.
